...
from pipes.DependencyParser import DependencyParserEN
...
class MyTestCase(unittest.TestCase):
    def test_advpl_in_sentence(self):
        ...
        parser = DependencyParserEN(text, 'en')
    ...
    def test_tobe_verb_in_sentence(self):
        ...
        parser = DependencyParserEN(text, 'en')
        found_comp = parser.parse_sentence(sent)
        self.assertTrue(found_comp[0].subj.text == 'Frey' and found_comp[0].obj.text == 'Geneva' and found_comp[
            0].verb.text == 'was from')
